                ...
                if (pass.equals(pass2)) {
                    if (this.isStrongPassword(pass)) {
                        if (!this.nameExists(name)) {
                            ...
                            basicResponse.setErrorCode(USER_NAME_EXISTS);
                        }}
                      else{
                            basicResponse.setErrorCode(ERROR_CODE_WEEK_PASSWORD);
                        }
                    } else {
                        basicResponse.setErrorCode(ERROR_CODE_PASSWORDS_NOT_EQUALS);
                    }
                } else {
                    basicResponse.setErrorCode(ERROR_CODE_MISSING_PASSWORD);
                }
            ...
            if (name != null && !name.isEmpty()) {
                if (pass != null && !pass.isEmpty()) {
                    ...
                    if (user != null) {
                        ...
                        basicResponse.setErrorCode(LOGIN_IS_WRONG);
                    }
                } else {
                    basicResponse.setErrorCode(ERROR_CODE_MISSING_PASSWORD);
                }
        ...
        basicResponse basicResponse = new basicResponse();
            ...
            if (user != null) {
                if (user.addNote(text)) {
                    ...
                    basicResponse.setErrorCode(THERE_IS_SUCH_NOTE);
                }
